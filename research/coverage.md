...
| Table and DataGrid, selection, sorting, filtering and bulk actions | SRC-027, SRC-037, SRC-012 | v9 package layout for react-table and react-utilities; APG grid and table keyboard patterns; component index. The dedicated v9 DataGrid usage page was not analyzed, so grid rules lean on APG and package source. | RULE-010, RULE-011, RULE-012 | | fixture: list and grid | Supported | |
...
| Searchable and filterable list page with DataGrid or Table | SRC-027, SRC-037, SRC-012 | Grid keyboard model; package source layout; component index for empty and loading states. | RULE-010, RULE-011, RULE-012, RULE-016 | | evaluation: task 1 | Supported | |
