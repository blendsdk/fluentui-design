...
| Forms, field choice, grouping, validation and submission | SRC-039, SRC-013, SRC-038, SRC-035 | Fluent 2 form-control usage for choosing the control by value domain, Switch versus Checkbox immediacy, option text, and inline popups; Field labeling and validation behavior; WAI form labeling and validation guidance; WCAG error identification. | RULE-005, RULE-006, RULE-007, RULE-037, RULE-038, RULE-039, RULE-040, RULE-041, RULE-042 | | fixture: record editor | Supported | |
...
| Searchable and filterable list page with DataGrid or Table | SRC-046, SRC-027, SRC-037, SRC-012 | Grid keyboard model; DataGrid sorting, focus, resizing, selection, and virtualization; package source layout; component index for empty and loading states. | RULE-010, RULE-011, RULE-012, RULE-016, RULE-031, RULE-032, RULE-033, RULE-034, RULE-035, RULE-036 | | evaluation: task 1 | Supported | |
...
| Create and edit form page with grouped fields and validation | SRC-039, SRC-013, SRC-038, SRC-035 | Form-control choice; Field composition; WAI labeling grouping and validation; WCAG error identification and suggestion. | RULE-005, RULE-006, RULE-007, RULE-029, RULE-030, RULE-037, RULE-038, RULE-039, RULE-040, RULE-041, RULE-042 | | evaluation: task 1 and task 5 | Supported | |
